...
// Ported verbatim from APK/android's
// app/src/main/java/in/iotsoft/edgefolio/ui/attendance/LivenessDetector.kt
// (already validated: LivenessDetectorTest.kt, 13 assertions). Do not change the
// thresholds here without re-running that test file too.
