...
// Ported near-verbatim from APK/android's
// app/src/main/java/in/iotsoft/edgefolio/ui/attendance/CameraXManager.kt
// (Timber swapped for android.util.Log — this plugin doesn't otherwise depend on Timber).
    ...
    fun bind(owner: LifecycleOwner, previewView: PreviewView) {
        ...
        future.addListener({
            ...
            try {
                ...
                Log.e("FaceLiveness", "CameraX bind failed", e)
            }
